...
<tr>
	<td class='text-right' colspan=4>Transporte <?php echo $simbolo_moneda;?></td>
...
<tr>
	...
	<th style="text-align: left;">INICIO DE PRODUCCIÓN</th>
...
<?php
	...
	$sql=mysqli_query($con, "select * from produccion where produccion.num_factura='".$id_factura."'");
	while ($row=mysqli_fetch_array($sql))
	{
//id_tmp=$row["id_tmp"];
	$codigo_producto_pr=$row['prod_encargado'];
	$cantidad_pr=$row['prod_fecha_hora'];
	//$nombre_producto=$row['nombre_producto'];
	...
	<tr>
		<td style="text-align: left;"><?php echo $codigo_producto_pr;?> </td>
		<td style="text-align: left;"><?php echo $cantidad_pr;?></td>
	</tr>			
...
<tr>
	<th style="text-align: left;">TRABAJADOR</th>
	<th class="left">INICIO DE HORNEO&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>

	<th></th>
</tr>
<?php
	$sumador_total=0;
	$sql1=mysqli_query($con, "select * from horneo where horneo.num_factura='".$id_factura."'");
	while ($row=mysqli_fetch_array($sql1))
	{
//id_tmp=$row["id_tmp"];
	$codigo_producto=$row['hor_nombre'];
	$cantidad=$row['hor_fecha'];
	//$nombre_producto=$row['nombre_producto'];
	...
	<tr>
		<td style="text-align: left;"><?php echo $codigo_producto;?> </td>
...
<tr>
	<th style="text-align: left;">TRABAJADOR</th>
	<th style="text-align: left;">INICIO DE EMPAQUE&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
...
<?php
	$sumador_total=0;
	$sql = "";
	$sql2=mysqli_query($con, "select * from empaque where empaque.num_factura='".$id_factura."'");
	while ($row=mysqli_fetch_array($sql2))
	{
//id_tmp=$row["id_tmp"];
	$codigo_producto=$row['emp_encargado'];
	$cantidad=$row['emp_fecha'];
	//$nombre_producto=$row['nombre_producto'];
