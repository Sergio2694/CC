	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Editar Inicio de Producción</h4>
		  </div>
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			   ...
			   <div class="form-group">
				<label for="mod_nombre" class="col-sm-3 control-label">Trabajador</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label for="mod_precio" class="col-sm-3 control-label">Inicio de Producción</label>
				<div class="col-sm-8">
