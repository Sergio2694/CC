<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Orden de Envíos | Panadería La Esmeralda";
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Editar Lote de Producción #<?php echo "$numero_factura"; ?> </h4>
		</div>
		...
		<?php 
			...
			include("modal/registro_horneo.php");
			include("modal/registro_empaque.php");
			include("modal/registro_produccion.php");
			...
			<form class="form-horizontal" role="form" id="datos_factura">
						...
						<div class="form-group row" style="display: none;">
							...
							<div class="col-md-2">
								<select class='form-control input-sm ' id="estado_factura" name="estado_factura">
									<option value="1" <?php if ($estado_factura==1){echo "selected";}?>>Ejecutado</option>
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevoProduccion">
						 <span class="glyphicon glyphicon-plus"></span> Inicio de Producción
						</button>
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevoHorneo">
						 <span class="glyphicon glyphicon-plus"></span> Inicio de Horneo
						</button>
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevoEmpaque">
						 <span class="glyphicon glyphicon-plus"></span> Inicio de Empaque
						</button>
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal" style="display: none">
						 <span class="glyphicon glyphicon-search"></span> Agregar productos
						</button>
						<button type="button" style="display: none"> class="btn btn-default" onclick="imprimir_factura('<?php echo $id_factura;?>')">
