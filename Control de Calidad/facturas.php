    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<a  href="nueva_factura.php" class="btn btn-info"><span class="glyphicon glyphicon-plus" ></span> Nueva Lotes de Producción</a>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Lotes de Producción</h4>
		</div>
